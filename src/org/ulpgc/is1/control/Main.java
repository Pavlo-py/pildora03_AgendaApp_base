...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Número de contactos en la agenda: " + Agenda.contactCount); //2

        // 5. Imprimir por pantalla el número de contactos del grupo “trabajo”.
        System.out.println("Número de contactos en el grupo 'trabajo': " + trabajoGroup.contactCount()); //1
        ...
        System.out.println("\nNúmero de contactos en el grupo 'trabajo' después de borrar: " + trabajoGroup.contactCount());
